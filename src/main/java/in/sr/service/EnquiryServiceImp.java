...
public class EnquiryServiceImp implements EnquiryService {
    ...
    public void deleteEnquiry(Integer eid) {
        // Check if the enquiry exists before attempting to delete
        if (!erepo.existsById(eid)) {
            throw new EntityNotFoundException("Enquiry not found"); // Optional: Handle not found
        }
